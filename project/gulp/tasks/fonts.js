		...
		if (fontsFiles) {
			...
			if (!fs.existsSync(fontsFile)) {
				...
				for (var i = 0; i < fontsFiles.length; i++) {
					// Записыванем подключения шрифтов в файл стилей
					...
					if (newFileOnly !== fontFileName) {
						...
						fs.appendFile(fontsFile, `@font-face {\n\tfont-family: ${fontFileName};\n\tfont-display: swap;\n\tsrc: ulr("../fonts/${fontFileName}.woff2") format("woff2"),ulr("../fonts/${fontFileName}.woff") format("woff");\n\tfont-weight: ${fontWeight};\n\tfont-style: normal;\n}\r\n`, cb);
				...
				console.log('Файл scss/fonts.scss уже существует. Для обновления файла необходимо его удалить!')
			}
		}
	});
